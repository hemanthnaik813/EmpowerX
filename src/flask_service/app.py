...
HEADERS = {"User-Agent": "hand-gesture-subtitles/1.0"}
...
# -----------------------
# ✅ MEDIAPIPE BASE (NO GLOBAL GRAPH!)
# -----------------------
...
def extract_hand_landmarks_from_bgr(bgr_img):
    ...
    # ✅ CREATE MEDIAPIPE HANDS PER REQUEST (CRITICAL FIX)
    with mp_hands.Hands(
...
# -----------------------
# ✅ /api/gesture (FIXED TIMESTAMP SAFE)
# -----------------------
